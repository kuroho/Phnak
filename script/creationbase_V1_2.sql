...
/* Date de création :  07/05/2021 16:27:46                      */
/*==============================================================*/
...
/*==============================================================*/
/* Table : PRODUIT_LIGNECO                                      */
/*==============================================================*/
create table PRODUIT_LIGNECO (
   IDPRODUIT            INT4                 not null,
   IDLIGNECOMMANDE      INT4                 not null,
   constraint PK_PRODUIT_LIGNECO primary key (IDPRODUIT, IDLIGNECOMMANDE)
);

/*==============================================================*/
/* Index : AJOUT_PK                                             */
/*==============================================================*/
create unique index AJOUT_PK on PRODUIT_LIGNECO (
IDPRODUIT,
IDLIGNECOMMANDE
);
...
/* Index : AJOUT_FK                                             */
/*==============================================================*/
create  index AJOUT_FK on PRODUIT_LIGNECO (
IDPRODUIT
);
...
/* Index : AJOUT2_FK                                            */
/*==============================================================*/
create  index AJOUT2_FK on PRODUIT_LIGNECO (
IDLIGNECOMMANDE
);
...
/*==============================================================*/
create unique index APPARTIENT_A_PK on SOUSCAT_PRODUIT (
IDPRODUIT,
IDSOUSCATEGORIE
);
...
/*==============================================================*/
create  index APPARTIENT_A_FK on SOUSCAT_PRODUIT (
IDPRODUIT
);
...
/*==============================================================*/
create  index APPARTIENT_A2_FK on SOUSCAT_PRODUIT (
IDSOUSCATEGORIE
);
...
alter table PRODUIT_LIGNECO
   add constraint FK_PRODUIT__PRODUIT_L_PRODUIT foreign key (IDPRODUIT)
      references PRODUIT (IDPRODUIT)
      on delete restrict on update restrict;

alter table PRODUIT_LIGNECO
   add constraint FK_PRODUIT__PRODUIT_L_LIGNECOM foreign key (IDLIGNECOMMANDE)
      references LIGNECOMMANDE (IDLIGNECOMMANDE)
      on delete restrict on update restrict;
